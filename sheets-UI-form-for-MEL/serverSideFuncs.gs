...
/*************************************************************
*  get a row of customer data by ID number
**************************************************************/
...
function getCustomerById(id){
  ...
  return { custID: customerInfo[0], 
                   ...
                   eventName: customerInfo[4], 
                   department: customerInfo[5]  }
}


/*************************************************************
*  edit a row of client data by ID number
**************************************************************/
